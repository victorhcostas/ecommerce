...
<head>
  ...
  <title>Link na Bio | Administração</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b>L</b>n<b>B</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Link</b> na <b>Bio</b></span>
    </a>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <!-- The message -->
                      <p>Seu link teve 133 acessos hoje</p>
                    </a>
                  </li>
                  <!-- end message -->
                </ul>
                ...
                <ul class="menu">
                  <li><!-- Task item -->
                    <a href="#">
                      ...
                      <h3>
                        Conseguir 500 acessos
                        <small class="pull-right">56%</small>
                      </h3>
                      <!-- The progress bar -->
                      <div class="progress xs">
                        <!-- Change the css width attribute to simulate progress -->
                        <div class="progress-bar progress-bar-aqua" style="width: 56%" role="progressbar" aria-valuenow="56" aria-valuemin="0" aria-valuemax="100">
                          <span class="sr-only">56% Completo</span>
                        </div>
                      </div>
                    </a>
                  </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo getUserName(); ?> - Gestor Financeiro
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/categories"><i class="fa fa-list" aria-hidden="true"></i> <span>Categorias</span></a></li>
        <li><a href="/admin/products"><i class="fa fa-television" aria-hidden="true"></i> <span>Produtos</span></a></li>
